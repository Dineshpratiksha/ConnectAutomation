Feature: External User Log a Case and Internal User Update the Logged case

  @DailyRegression
  Scenario Outline: External User Log a Case and Internal User Update the Logged case
